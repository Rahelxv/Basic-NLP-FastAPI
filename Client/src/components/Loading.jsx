...
const Loading = () => {
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md animate-fadeIn">
      ...
      <div className="w-[90%] max-w-sm p-10 bg-[#1a1c22]/80 rounded-4xl border border-white/10 shadow-2xl flex flex-col items-center">
        ...
        <div className="w-full h-0.5 bg-white/5 mt-10 overflow-hidden rounded-full">
